...
export default function JaradaStackSectionDesktop() {
    useEffect(() => {
    ...
    return (
        <>
            ...
            <section className="stack-section bg-1">
            ...
            <section className="stack-section bg-2">
                <div className="overlay" />
            ...
            <section className="stack-section bg-3">
                <div className="overlay" />
            ...
            <section className="stack-section bg-5">
                <picture>
                    <source
                        media="(max-width: 1024px)"
            ...
            <section className="stack-section bg-6">
                <div className="overlay" />
            ...
            <section className="stack-section bg-7">
                <div className="overlay" />
